...
$routes['/relatorio/{\d+:idRelatorio}/categoria/{\d+:idCategoria}/salvar'] = "Relatorios->salvarCategoria(\$idRelatorio,\$idCategoria)";
$routes['/relatorio/{\d+:idRelatorio}/categoria/{\d+:idCategoria}/remover'] = "Relatorios->removerCategoria(\$idRelatorio,\$idCategoria)";
...
$routes["/relatorio/{\d+:idRelatorio}/propriedades"] = "Relatorios->propriedades(\$idRelatorio)";
